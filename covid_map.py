...
levels_description_dictionary = {
    1: "1. Źle dobrane - cykliczne - mapowanie wartości na kolory może sugerować, że ilość zachorowań w Polsce i Rosji jest prawie taka sama...",
    ...
    3: "3. Zmiana mapowania wartości na kolory na mapowanie sekwencyjne pozwala zobaczyć relację między ilościami zachorowań w poszczególnych krajach. \n" +
       "Jednak przełamanie standardu - pokazanie najmniejszych wartości najciemniejszym kolorem - zdecydowanie pogarsza zrozumienie wizualizacji.",
    4: "4. Dodanie legendy umożliwia pełne zrozumienie wizualizacji, jednak ciągle nie jest ona wygodna i intuicyjna ze względu na przełamanie pewnego schematu...",
